...
# end of driveCalc()
    if op_str == "+":
        result = add(num1_flt, num2_flt)

    elif op_str == "-":
        result = subtract(num1_flt, num2_flt)

    elif op_str == "*":
        result = multiply(num1_flt, num2_flt)

    elif op_str == "/":
        result = divide(num1_flt, num2_flt)

    elif op_str == "%":
        result = modulus(num1_flt, num2_flt)
...
def add(num1_flt, num2_flt):
    return num1_flt + num2_flt # function to add values and return value
    print("\t add()")
# end of add()

def subtract(num1_flt, num2_flt): #function to substract the first inputted value from the second one.
    return num1_flt - num2_flt
    print("\t substract()")
# end of subtract()

def multiply(num1_flt, num2_flt): #function to multiply the inputted values.
    return num1_flt * num2_flt
    print("\t multiply()")
#end of multiply()

def divide(num1_flt, num2_flt): #function to divide the first inputted value (numerator) by the second one (denominator).
    return num1_flt / num2_flt
    print("\t divide()")
# end of divide()

def modulus(num1_flt, num2_flt): # function to return the modulus result; the remainder.
    return num1_flt % num2_flt
    print("\t modulus()")
#end of modulus()
